...
const MessageModelSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'roomId_createdAt_id': IndexSchema(
      id: 4892615233660848021,
      name: r'roomId_createdAt_id',
      unique: false,
      replace: false,
      properties: [
        IndexPropertySchema(
...
extension MessageModelQueryWhere
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> roomIdEqualTo(
      String roomId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'roomId',
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> roomIdNotEqualTo(
      String roomId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdEqualToAnyCreatedAtId(String roomId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'roomId_createdAt_id',
        value: [roomId],
      ));
    });
  }
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdNotEqualToAnyCreatedAtId(String roomId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdCreatedAtEqualToAnyId(String roomId, DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'roomId_createdAt_id',
        value: [roomId, createdAt],
      ));
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdEqualToCreatedAtNotEqualToAnyId(String roomId, DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'roomId_createdAt_id',
              lower: [roomId],
              upper: [roomId, createdAt],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'roomId_createdAt_id',
              lower: [roomId, createdAt],
              includeLower: false,
              upper: [roomId],
            ));
      } else {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdEqualToCreatedAtGreaterThanAnyId(
    String roomId,
    DateTime createdAt, {
    bool include = false,
  }) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdEqualToCreatedAtLessThanAnyId(
    String roomId,
    DateTime createdAt, {
    bool include = false,
  }) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdEqualToCreatedAtBetweenAnyId(
    String roomId,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'roomId_createdAt_id',
        lower: [roomId, lowerCreatedAt],
        includeLower: includeLower,
        upper: [roomId, upperCreatedAt],
        includeUpper: includeUpper,
      ));
    });
  }
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdCreatedAtIdEqualTo(String roomId, DateTime createdAt, String id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'roomId_createdAt_id',
        value: [roomId, createdAt, id],
      ));
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause>
      roomIdCreatedAtEqualToIdNotEqualTo(
          String roomId, DateTime createdAt, String id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension RoomIdAnyQuery on QueryBuilder<MessageModel, MessageModel, QWhere> {
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> anyRoomId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IndexWhereClause.any(
        indexName: 'roomId_createdAt_id',
      ));
    });
  }
}
